...
include("framework/navbar/unavbar.php");
...
if($result->num_rows > 0){
  if ($row= $result->fetch_assoc()) {
    ...
    $incident = $row['Report'];
    $securityagent = $row['SecurityAgent'];
...
<?php include('core/translate.php'); ?>
 <div class="contentArea">
   <form class="form" action="core/reportdata.php" method="post">
     ...
     <table border="0" cellspacing="1" cellpadding="1" class="tableb">
       ...
       <tr>
         <td colspan="2">
           ...
           <input type="hidden" name="securityagent" value="<?php echo $securityagent; ?>">
           <input type="hidden" name="reportedby" value="<?php echo $reportedby; ?>">
       ...
       <tr>
         <td><p>Incident: </p></td>
         <td>
          <? if(empty($progressnote)){?>
            <textarea name="incident" rows="8" cols="80" placeholder="Update Incident Report" > <?php echo $incident;?> </textarea>
           <?php}
           else{?>
       ...
       <tr>
         ...
         <td>
            <p style="text-align:left;"><?php echo $securityagent;?></p>
         </td>
       </tr>
       <tr>
         <td><p>Reported By: </p></td>
         <td>
            <p style="text-align:left;"><?php echo $reportedby;?></p>
       </tr>
       <tr>
         <td><p>Progress Notes:</p></td>
         <td>
        <p style="text-align:left;"><?php echo $progressnote;?></p>
