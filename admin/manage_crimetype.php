...
<div class="content_admin">
    <span style="text-align:center;color:white;"><h1>Manage Crime Type</h1></span>
          <table class="table table-striped table-bordered bootstrap-datatable datatable">
            ...
            <?php
              ...
              if(isset($_GET['pageno'])){
               ...
               $page_sql = "SELECT COUNT(*) FROM crime";
               $result = $conn->query($page_sql);
               $total_rows = mysqli_fetch_array($result)[0];
               $total_pages = ceil($total_rows/$rec_per_page);

              $sql = "SELECT * FROM crime ORDER BY ID LIMIT $offset, $rec_per_page";
            ...
            <tr>
              ...
              <td class="center">
            <a class="btn btn-info" href="edit_crimetype.php?id=<?php echo $row['ID']; ?>">
