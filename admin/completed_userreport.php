<title>Online Crime Reporting System | UserReport Data</title>
...
<div class="content_admin">
    <h1>Closed/Completed User Reports</h1>
          <table class="table table-striped table-bordered bootstrap-datatable datatable">
            ...
            <?php
              ...
              $sql = "SELECT * FROM incident WHERE Status='Closed' and ReportedBy!='Anonymous' ORDER BY ID LIMIT $offset,$rec_per_page";
            ...
            <tr>
              <td colspan="9"><?php echo "no results to display"; ?></td>
