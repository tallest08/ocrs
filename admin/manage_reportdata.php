<title>Online Crime Reporting System | Anonymous Report Data</title>
...
<div class="content_admin">
    <span style="text-align:center;color:white;"><h1>Anonymous Report</h1></span>
          <table class="table table-striped table-bordered bootstrap-datatable datatable">
            ...
            <?php
              ...
              $sql = "SELECT * FROM incident ORDER BY ID LIMIT $offset,$rec_per_page";
            ...
            <tr>
              ...
              <td class="center">
            <a class="btn btn-info" href="core/edit_crimetype.php?id=<?php echo $row['ID']; ?>">
